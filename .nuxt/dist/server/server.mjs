...
const unhead_AdNr86FPav = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const router_YGvU4Nlg5l = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:router",
  enforce: "pre",
  setup(nuxtApp) {
...
const revive_payload_server_asQmRoImVl = /* @__PURE__ */ defineNuxtPlugin({
...
const plugins = [
  unhead_AdNr86FPav,
  router_YGvU4Nlg5l,
  revive_payload_server_asQmRoImVl,
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-D-UkZVih.js").then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-Bvueyayd.js").then((r) => r.default || r));
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.1_@types+node@18.19.24_vite@5.2.7/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.1_@types+node@18.19.24_vite@5.2.7/node_modules/nuxt/dist/app/components/nuxt-root.vue");
